...
class CountObject():
    ...
    def __init__(self,input_video_path,output_video_path,fps) -> None:
        ...
        print(f"FPS del video de entrada: {self.video_info.fps}")
        self.video_info.fps =fps if fps > 0 else self.video_info.fps
        print(f"FPS del video de entrada luego es: {self.video_info.fps}")
...
if __name__ == "__main__":
    ...
    obj = CountObject(args.input,args.output,fps_valor)
    obj.process_video()
